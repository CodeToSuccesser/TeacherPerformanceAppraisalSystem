...
CREATE TABLE `params`(
	...
	`value` DECIMAL(9, 3) NOT NULL COMMENT '参数权值',
...
CREATE TABLE `course_hours_modify_record`(
	...
	`course_cridet` DECIMAL(6, 2) NOT NULL COMMENT '学分, 非空',
	`total_hours` DECIMAL(6, 2) NOT NULL COMMENT '总学时数, 非空',
	...
	`modify_course_cridet` DECIMAL(6, 2) DEFAULT NULL COMMENT '修改学时',
	`modify_total_hours` DECIMAL(6, 2) DEFAULT NULL COMMENT '修改总学时数',
...
CREATE TABLE `intern`(
	...
	`semester` TINYINT(4) NOT NULL DEFAULT 1 COMMENT '学期, 默认1 第一学期, 2 第二学期',
	`school_year` VARCHAR(32) NOT NULL COMMENT '学年',
    `is_in_school` TINYINT(4) NOT NULL DEFAULT 0 COMMENT '对于师范实习记录，标注为校内或校外实习，校外-0，校内-1',
    `is_deleted` TINYINT(4) NOT NULL DEFAULT 0 COMMENT '逻辑删除标识, 0 无删除, 1 已删除',
	`remark` VARCHAR(255) DEFAULT NULL COMMENT '备注',
	`update_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '数据最新操作时间',
	`create_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `course_score`(
	...
	`c1_value` DECIMAL(9, 3) NOT NULL COMMENT 'c1权值',
	`c2_value` DECIMAL(9, 3) NOT NULL COMMENT 'c2权值',
	`c3_value` DECIMAL(9, 3) NOT NULL COMMENT 'c3权值',
	`c4_value` DECIMAL(9, 3) NOT NULL COMMENT 'c4权值',
	`c5_value` DECIMAL(9, 3) NOT NULL COMMENT 'c5权值',
	`c6_value` DECIMAL(9, 3) NOT NULL COMMENT 'c6权值',
	`c7_value` DECIMAL(9, 3) NOT NULL COMMENT 'c7权值',
	`c8_value` DECIMAL(9, 3) NOT NULL COMMENT 'c8权值',
	`total` DECIMAL(9, 3) NOT NULL COMMENT '授课总分',
	`semester` TINYINT(4) NOT NULL DEFAULT 1 COMMENT '学期, 默认1 第一学期, 2 第二学期',
	`school_year` VARCHAR(32) NOT NULL COMMENT '学年',
	`admin_id` BIGINT(20) DEFAULT NULL COMMENT '处理的管理员编码',
	`update_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '数据最新操作时间',
...
CREATE TABLE `paper_score`(
	...
	`teacher_id` BIGINT(20) NOT NULL COMMENT '教师编码',
	`paper_id` BIGINT(20) NOT NULL COMMENT '论文指导信息编码',
	`c9_value` DECIMAL(9, 3) NOT NULL COMMENT 'c9权值',
	`c10_value` DECIMAL(9, 3) NOT NULL COMMENT 'c10权值',
	`c11_value` DECIMAL(9, 3) NOT NULL COMMENT 'c11权值',
	`c12_value` DECIMAL(9, 3) NOT NULL COMMENT 'c12权值',
	`c13_value` DECIMAL(9, 3) NOT NULL COMMENT 'c13权值',
	`total` DECIMAL(9, 3) NOT NULL COMMENT '论文指导总分',
	`semester` TINYINT(4) NOT NULL DEFAULT 1 COMMENT '学期, 默认1 第一学期, 2 第二学期',
	`school_year` VARCHAR(32) NOT NULL COMMENT '学年',
	`admin_id` BIGINT(20) DEFAULT NULL COMMENT '处理的管理员编码',
	`update_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '数据最新操作时间',
...
CREATE TABLE `intern_score`(
	...
	`c14_value` DECIMAL(9, 3) NOT NULL COMMENT 'c14权值',
	`c15_value` DECIMAL(9, 3) NOT NULL COMMENT 'c15权值',
	`total` DECIMAL(9, 3) NOT NULL COMMENT '实习指导总分',
	`semester` TINYINT(4) NOT NULL DEFAULT 1 COMMENT '学期, 默认1 第一学期, 2 第二学期',
	`school_year` VARCHAR(32) NOT NULL COMMENT '学年',
	`admin_id` BIGINT(20) DEFAULT NULL COMMENT '处理的管理员编码',
	`update_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '数据最新操作时间',
...
CREATE TABLE `assessment`(
	...
	`semester` TINYINT(4) NOT NULL DEFAULT 1 COMMENT '学期, 默认1 第一学期, 2 第二学期',
	`school_year` VARCHAR(32) NOT NULL COMMENT '学年',
	`course_quality` DECIMAL(14, 3) NOT NULL COMMENT '授课总分',
	`paper_quality` DECIMAL(14, 3) NOT NULL COMMENT '论文指导总分',
	`intern_quality` DECIMAL(14, 3) NOT NULL COMMENT '实习指导总分',
	`other_quality` DECIMAL(14, 3) NOT NULL DEFAULT 0 COMMENT '其他总分',
	`total_quality` DECIMAL(14, 3) NOT NULL COMMENT '总分',
	`update_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '数据最新操作时间',
	`create_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
	PRIMARY KEY(`id`)
